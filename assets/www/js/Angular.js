...
function onDeviceReady() {
    ...
    push.on('notification', function(data) {
        ...
        //alert("hello");
         ...
         console.log(device_type_data.event);
         localStorage.setItem("event_name",device_type_data.event);
         ...
         var user_detail_check = localStorage.getItem( "userDetail" );
            if( user_detail_check ) {
                ...
                console.log(device_type_data.session_id);
                if ( device_type_data.session_id ){
            // var data = '';
            //alert("hiu");
                console.log("else remember");
                var callerdata = JSON.stringify({'u_name': device_type_data.originator_displayname, 'sessionId': device_type_data.session_id , 'sessionToken': device_type_data.video_token, 'image':device_type_data.profile_image, 'receiverid': device_type_data.receiver_id, 'userId':device_type_data.originator_id, 'CallId':device_type_data.call_id})
                localStorage.setItem("caller_Data",callerdata);
                window.plugins.nativepagetransitions.slide( {
                    "href" : "#/home/videocallAccept"
                } ); 
         }
        else if(device_type_data.event == "user_rejected") {
            //alert("rejected");
            // alert(JSON.stringify(data.additionalData));
            console.log(JSON.stringify(device_type_data));
            // hello.endCalling();
            ...
            var Id = device_type_data.receiver_id;
            var Id1 = device_type_data.originator_id;
            // alert(userid);
            hello.endCalling(" ");
            console.log(Id);
            if( userid == Id){
        ...
        else if (device_type_data.event == "pro_rejected") {
            console.log("pro reject");
            hello.endCalling("proRejectsCall");
        }
        else if(device_type_data.event == "ended") {
            ...
            // console.log(userid);
            // console.log(Id);
            var costOfCall1 = device_type_data.call_rev_share;
            var durationOfCall1 = device_type_data.call_duration;
            var showNamedata1 = device_type_data.originator_displayname;
            var IdReceiver1 = device_type_data.originator_id;
